...
class Vehicule(models.Model):
    vehicule_type = models.ForeignKey(Type, verbose_name=("Type"), on_delete=models.CASCADE)
...
class TarifLocation(models.Model):
    ...
    type_vehicule = models.ForeignKey(VehiculeType, verbose_name=_(""), on_delete=models.CASCADE)    