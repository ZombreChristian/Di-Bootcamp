...
class Location(models.Model):
    ...
    date_retour = models.DateTimeField(auto_now_add=Tr)
...
class TarifLocation(models.Model):
    ...
    type_vehicule = models.ForeignKey(TypeVehicule, related_name=("Type"), on_delete=models.CASCADE)
    taille_vehicule = models.ForeignKey(TailleVehicule, related_name=("Taille"), on_delete=models.CASCADE)    