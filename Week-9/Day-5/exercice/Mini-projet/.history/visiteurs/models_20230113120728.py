...
class Profile(models.Model):
    ...
    photo_profile = models.ImageField(upload_to='images',blank=True)
    ...
    type_user = [
        (sejour,'sejour'),(enseignant,'enseignant'),(parent,'parent')
    ]
    
    type_profile = models.CharField(max_length=100,choices= type_user,default=sejour)
